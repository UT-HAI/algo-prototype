...
import { Typography, Divider, Grid, Card, Button, Stack, Box } from "@mui/material"
import DownloadIcon from '@mui/icons-material/FileDownloadOutlined';
import DeleteIcon from '@mui/icons-material/Delete';
import { Link } from "react-router-dom";
import { useSelectionsUsers, useFeatures } from "../../util/hooks/contextHooks";
...
const Admin = () => {
    ...
    return (<>
        ...
        <FlexContainer maxidth="lg" sx={{pt: 4}}>
                ...
                <Box mt={4} sx={{display: 'flex', flexWrap: 'wrap'}}>
