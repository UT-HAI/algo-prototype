...
export default {
    ...
    selection: <>
        ...
        <p>You can view each <InfoTip text={infotips.feature}>feature</InfoTip> by clicking on its name in the list. Each feature has a description,
         a <InfoTip text="A distribution of a variable is it's shape, which shows the values in the data and how frequently they each occur. Distributions can be visualized in many ways depending on the type of variable.">distribution</InfoTip>, and summary statistics.</p>
    ...
    comparison: <>
        ...
        <p>For numerical vs categorical comparisons, a <InfoTip text="Violin plots show the distribution of a numerical variable for each value of a categorical variable.">violin plot</InfoTip> is used.</p>
